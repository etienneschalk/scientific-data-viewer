<!--
  ...
  Generated on: 2026-07-01T10:51:16.050093
...
- **`scientificDataViewer.webviewExportTheme`**
  - (type: `string`, default: `""` (empty string))
  - Theme to use when exporting webview content. If empty, uses the current VS Code theme. If set, overrides with the specified theme for exports.
...
- **`scientificDataViewer.plotTimeoutMs`**
  ...
  - Timeout in milliseconds for matplotlib plot generation (Issue #126).
- **`scientificDataViewer.outlineEnabled`**
  - (type: `boolean`, default: `true`)
  - Build the Scientific Data Structure outline sidebar. Reload the window after changing this setting.
